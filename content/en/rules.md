...
- The current VvE fee per apartment is determined in accordance with the currently approved budget.
...
- Painting, wallpapering and tiling
- Ceilings, floors and balconies (surface finishes), and plasterwork
...
- Galleries and the stairwell must be kept **completely clear at all times**
...
- You must also tolerate main connections and meters (gas, water, electricity) inside your home.
- 📅 **Current:** the ALV of 13 April 2026 decided that **Techem will install an individual water meter in every apartment**. Every resident gets a meter and must grant access for the installation.
...
|---|---|
| Small home office (no customers at home, no nuisance) | Food business with customer pick-up, cooking smells or delivery traffic |
| Small home practice (provided it causes no unreasonable nuisance to neighbours) | Any activity that causes unreasonable nuisance |

The test is always: **does the activity cause unreasonable nuisance** for other residents?
...
| VvE responsibility | Your own responsibility |
|---|---|
| Foundations, load-bearing walls, roofs | Interior painting and wallpapering |
| Exterior façades, window frames, outside doors | Floor and ceiling finishes |
| Galleries, stairwell, hall | Sanitary fittings and pipes in your home |
| Central heating and pipes | Locks and fittings (doors/windows) |
| **Radiators and radiator valves** ⚠️ | Your letterbox |
| Lift | Glass damage in your apartment |
| Fire detectors in common areas | Smoke detectors inside your home |
...
- Take reasonable measures to prevent such damage. *(Model Regulations 1972, Art. 12)*
- 💡 If you call out VvE Metea for a fault that turns out to have a **private cause** (e.g. a blockage caused by grease, a leaking sealant joint), the costs are **passed on to you**. Check VvE Metea's "Own maintenance" guide first.
...
- Krishnamoorthy — Matterhorn 34
- Navaneeth Sen — Matterhorn 42

**In case of violation of the rules:**
The manager first sends a **written warning** (registered letter). If the person does not comply, the owners' meeting can impose a **fine** (Model Regulations 1972, Art. 27). For repeated violations within one year after a warning, the meeting can additionally **exclude** the violator from use of the private area (Art. 24).
