...
- De huidige VvE-bijdrage per appartement is conform de begroting die momenteel van kracht is.
...
- Schilder-, behang- en tegelwerk
- Plafonds, vloeren en balkons (afwerklagen) en stucwerk
...
- Galerijen en trappenhuis moeten **te allen tijde volledig vrij** zijn
...
- Hoofdaansluitingen en meters (gas, water, elektra) in uw woning moet u eveneens gedogen.
- 📅 **Actueel:** de ALV van 13 april 2026 heeft besloten dat **Techem in elk appartement een individuele watermeter plaatst**. Elke bewoner krijgt een meter en dient hiervoor toegang te verlenen.
...
|---|---|
| Klein thuiskantoor (geen klanten aan huis, geen overlast) | Kookbedrijf met afhaalklanten, kookgeuren of bezorgers |
| Kleine thuispraktijk (mits geen onredelijke hinder voor buren) | Elke activiteit die onredelijke hinder veroorzaakt |

De toets is altijd: **veroorzaakt de activiteit onredelijke hinder** voor andere bewoners?
...
| VvE verantwoordelijkheid | Uw eigen verantwoordelijkheid |
|---|---|
| Funderingen, dragende muren, daken | Schilder- en behangwerk binnenin |
| Buitengevels, kozijnen, deuren (buiten) | Vloer- en plafondafwerking |
| Galerijen, trappenhuis, hal | Sanitair en leidingen in uw woning |
| Centrale verwarming en leidingen | Hang- en sluitwerk (deuren/ramen) |
| **Radiatoren en radiatorkranen** ⚠️ | Uw brievenbus |
| Lift | Glasschade in uw appartement |
| Brandmelders in gemeenschappelijke ruimten | Rookmelders binnenin uw woning |
...
- Neem redelijke maatregelen om zulke schade te voorkomen. *(Modelreglement 1972, Art. 12)*
- 💡 Roept u VvE Metea op voor een storing die een **privéoorzaak** blijkt te hebben (bijv. verstopping door vet, lekkende kitrand)? Dan worden de kosten **aan u doorbelast**. Raadpleeg eerst de handleiding "Eigen onderhoud" van VvE Metea.
...
De beheerder stuurt eerst een **schriftelijke waarschuwing** (aangetekend). Geeft de betrokkene hieraan geen gevolg, dan kan de vergadering een **boete** opleggen (Modelreglement 1972, Art. 27). Bij herhaalde overtreding binnen één jaar na een waarschuwing kan de vergadering bovendien het gebruik van het privégedeelte **ontzeggen** (Art. 24).
